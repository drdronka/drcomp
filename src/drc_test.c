...
{
  //drc_core_compress(test_path_in, test_path_comp);
  //drc_core_decompress(test_path_comp, test_path_decomp);
 
  if(argc > 3)
  {
    drc_core_compress(argv[1], argv[2]);
    drc_core_decompress(argv[2], argv[3]);
  }
  else
  {
